...
<div class="row">
<div class="col-lg-6">
<span class="logo">TEST YOUR SKIL(Online Quiz)</span></div>
...
$qns=$row['qns'];
$qid=$row['qid'];
echo '<span id="countdown" class="timer"></span> remaining time<br/>';
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" style="font-family:'typo' "><span style="color:orange";"background:blue">Developers</span></h4>
      </div>
    ...
    <div class="row">
     <div class="col-md-4">
     <img src="image/1.jpg" width=100 height=100 alt="MNC" class="img-rounded">
     </div>
     <div class="col-md-5">
    <a href="http://yugeshverma.blogspot.in" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">Online Quiz</a>
    <h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">cont no:+91 9900990099</h4>
    <h4 style="font-family:'typo' ">1.Chitra P J</h4>
    <h4 style="font-family:'typo' ">2.Meghana S Shetty</h4>
    <h4 style="font-family:'typo' ">3.Nanditha G M</h4>
    <h4 style="font-family:'typo' ">Shree devi insitute of Technology ,Mangalore</h4></div></div>
    </p>
      </div>
